...
export function SnapAndShare() {
  ...
  return (
    <section className="relative overflow-hidden bg-royal-950/80 py-24 sm:py-32">
          ...
          <div className="mt-12 flex flex-col items-center justify-center gap-8 rounded-3xl bg-cream-50 p-8 shadow-lg sm:flex-row sm:p-10">
            ...
            <div className="text-center sm:text-left">
              ...
              <div className="mt-5 flex flex-col items-center gap-3 sm:flex-row sm:items-stretch">
                ...
                <button
                  onClick={copyLink}
                  className="inline-flex items-center justify-center gap-2 rounded-lg bg-royal-800 px-5 py-2.5 text-sm uppercase tracking-wide text-cream-50 transition-all hover:bg-royal-900"
                >
