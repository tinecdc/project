    ...
    <section className="relative overflow-hidden bg-royal-950/75 py-24 sm:py-32">
      ...
      <div className="relative mx-auto max-w-3xl px-6 text-center">
        ...
        <Reveal variant="up" delay={200}>
          <p className="font-serif text-xl italic leading-relaxed text-brown-700">
        ...
        <Reveal variant="up" delay={350}>
          <div className="mt-10 space-y-6">
            ...
            <div className="flex items-start gap-4 rounded-2xl bg-cream-50 p-6 text-left shadow-sm">
              <span className="mt-1 flex h-10 w-10 flex-none items-center justify-center rounded-full bg-cream-300 text-brown-700">
                <Wallet size={20} />
              </span>
              <p className="font-serif text-lg leading-relaxed text-brown-700">
